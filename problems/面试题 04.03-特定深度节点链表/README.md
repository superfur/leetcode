...
1. 尝试修改图形搜索算法，从根开始追踪深度。
2. 从层号映射到该层节点的散列表或数组也许有些用处。
3. 你应该能够提出一个既包括深度优先搜索又包含广度优先搜索的算法。
...
class Solution {
    func listOfDepth(tree: ?BinaryTreeNode): Array<?ListNode> {
